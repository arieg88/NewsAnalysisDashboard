...
# Define the layout and structure of the navigation bar
navbar = dbc.Navbar(
    dbc.Nav(
        [
            dbc.NavLink(
            ...
            dbc.Stack([
                ...
                dbc.Tooltip('Financial Narrative Insights (Not Yet Implemented)', target='financial_narrative_link', placement='right'),
            ]),
            dbc.NavLink(
