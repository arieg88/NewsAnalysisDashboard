...
# Function to create a card with filters for article selection
def create_article_selection_card(placeholder='Select an article'):
    """
    Creates a card layout for selecting and displaying articles.

    Args:
        placeholder (str): The placeholder text for the article selection dropdown.

    Returns:
        dbc.Card: A Dash Bootstrap Card component containing article selection elements.
    """
    return dbc.Card(
        [
            dbc.CardHeader(
